...
#define	MAX_OF_DA_AD_CH3    255

#ifdef	AD7792
#define	MAX_OF_ADC    32767
#else
#define	MAX_OF_ADC    4095
#endif

#define	DAC7562    1
#define	KEY_LONG_PRESS_TIME1  2000 
#define	KEY_LONG_PRESS_TIME   180000
#define	KEY_CAL_PRESS_TIME   500000
...
#define CH1_CURR_PARA_SET_CAL  8
#else
#define CH1_CHOICE  1
#define CH2_CHOICE  2 
#define	CH1        "CH1"
...
#define CH3_VOLT_SET_CAL  10
#define CH3_VOLT_DISP_CAL  11
...
#define LED1_M1(x)	x ? GPIO_SetBits(GPIOE,GPIO_Pin_6): GPIO_ResetBits(GPIOE,GPIO_Pin_6)
#define LED1_M2(x)	x ? GPIO_SetBits(GPIOC,GPIO_Pin_13): GPIO_ResetBits(GPIOC,GPIO_Pin_13)
#define LED1_M3(x)	x ? GPIO_SetBits(GPIOC,GPIO_Pin_14): GPIO_ResetBits(GPIOC,GPIO_Pin_14)
#define LED1_M4(x)	x ? GPIO_SetBits(GPIOC,GPIO_Pin_15): GPIO_ResetBits(GPIOC,GPIO_Pin_15)
#define LED1_M5(x)	x ? GPIO_SetBits(GPIOC,GPIO_Pin_6): GPIO_ResetBits(GPIOC,GPIO_Pin_6)
...
#define LED_SETVIEW(x)	x ? GPIO_SetBits(GPIOB,GPIO_Pin_3): GPIO_ResetBits(GPIOB,GPIO_Pin_3)
#define LED_BEEP(x)	x ? 	GPIO_SetBits(GPIOB,GPIO_Pin_4): GPIO_ResetBits(GPIOB,GPIO_Pin_4)
#define LED_LOCK(x)	x ? 	GPIO_SetBits(GPIOB,GPIO_Pin_8): GPIO_ResetBits(GPIOB,GPIO_Pin_8)
#define LED_CH3(x)	x ? 	GPIO_SetBits(GPIOB,GPIO_Pin_9): GPIO_ResetBits(GPIOB,GPIO_Pin_9)
...
#define Wave_long	  1
#define Volt_max  32
#define Volt_max_ch3  6

#define Volt_max_cal  40
#define Volt_min  0
#define Curr_max  3.2

#define Curr_max_cal  4.0
#define Curr_min  0
...
extern u8 cur_page;
extern u8 recall_SET_FLG;
extern u8 SCPI_WAVE2_SET;
extern u8 SCPI_WAVE_SET;
extern u8 CHAN_STAT,CHAN_SEL;
extern u8 CH1_STAT;
extern u8 CH2_STAT;
...
extern float ch1_curr_disp,ch2_curr_disp,para_curr_disp ;
extern float ch1_pow_disp,ch2_pow_disp ;
extern float volt_step,curr_step;
extern float ch1_volt_disp_cal,ch2_volt_disp_cal,ch3_volt_disp_cal ;
...
extern u8 key_stat;
extern u8 key_vale;
extern u8 file_cur,recall_count;
extern u8 screen_reverse;
extern u8 operate_cur,  para_ch1_on_flg;
extern  u8 beep_on;
...
//float tmr_volt[5];
//float tmr_curr[5];
double volt_set_step;
double curr_set_step;
double cal_volt_set;
double cal_curr_set;
double cal_volt_disp;
double cal_curr_disp;
}
SET_PARA,*P_SET_PARA;
...
extern SET_PARA CHAN1,CHAN2,CHAN3;
...
extern Cal_K  PARA_K[12];
extern float ch3_volt_disp;
